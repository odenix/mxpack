...
import io.github.odenix.minipack.core.internal.AbstractBufferAllocator;
import io.github.odenix.minipack.core.internal.PooledBufferAllocator;
import io.github.odenix.minipack.core.internal.UnpooledBufferAllocator;

/// An allocator of byte and char buffers.
///
/// By default, MiniPack allocates buffers with an [unpooled][#ofUnpooled] 
...
///
/// For usage examples, see [Buffer allocation](https://odenix.github.io/minipack/examples/#buffer-allocation).
public sealed interface BufferAllocator extends Closeable
  ...
  sealed interface UnpooledOptionBuilder permits AbstractBufferAllocator.OptionBuilderImpl {
    ...
    /// [MiniPackException.SizeLimitExceeded] is thrown.
    ///
  ...
  /// @throws MiniPackException.SizeLimitExceeded if the given capacity
