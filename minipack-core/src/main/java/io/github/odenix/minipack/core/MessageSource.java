...
import io.github.odenix.minipack.core.internal.Exceptions;
import io.github.odenix.minipack.core.internal.MessageSourceImpl;
...
public sealed interface MessageSource permits MessageSourceImpl {
  ...
  /// @return the length value read
  /// @throws MiniPackException.SizeLimitExceeded if the value is greater than [Integer#MAX_VALUE]
  /// @throws EOFException if the end of input is reached before the value has been read
  /// @throws IOException if an I/O error occurs
