...
/** Factory methods for constructing [MessageOutput]s. */
object MessageOutputs {
  /**
   * Returns a new [MessageOutput] for a [LeasedByteBuffer].
   *
   * For further documentation of method parameters, see [MessageOutput.Buffer.OptionBuilder].
   */
  fun ofBuffer(
