...
abstract class Example {
  ...
  val outChannel: WritableByteChannel by lazy {
    Channels.newChannel(outStream)
  }
  val inChannel: ReadableByteChannel by lazy {
    Channels.newChannel(inStream)
  }
  val writer: MessageWriter by lazy {
    MessageWriter.of(outStream)
  }
  val reader: MessageReader by lazy {
    MessageReader.of(inStream)
  }
}