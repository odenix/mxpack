...
import org.odenix.mxpack.core.internal.util.LockFreePool;

/// A [BufferAllocator] that pools buffers.
///
/// MxPack supports buffer pooling based on the following assumptions:
/// * MxPack is used with different garbage collectors (JVM, Graal native image, etc.)
/// * pooling heap buffers can be useful
/// * using direct buffers can be useful
/// * pooling direct buffers is useful
///
/// If buffer pooling proves unnecessary for MxPack,
